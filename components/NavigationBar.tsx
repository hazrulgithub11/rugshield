...
// New icons for the updated tabs
...
const Monitor = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M6 16h12V7H6v9zm6-8l4 4h-2.55v3h-2.91v-3H8l4-4z"/>
  </svg>
)

const Protection = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const NavigationBar = () => {
    ...
    const tabs: { id: TabType; label: string; Icon: React.FC<{ className?: string }> }[] = [
        ...
        { id: 'leaderboard', label: 'Monitor', Icon: Monitor },
        { id: 'friends', label: 'Protection', Icon: Protection },
        { id: 'earn', label: 'Settings', Icon: Settings },
    ]
